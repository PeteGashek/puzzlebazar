...
public class AsyncProviderBinding implements Binding {
  ...
  public void writeCreatorMethods(SourceWriter writer, String creatorMethodSignature) {
     ...
     String methodCode =
       ...
       "    public void get(final com.google.gwt.user.client.rpc.AsyncCallback<" +
             targetKeyName + "> callback) { \n" +
       "      com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() { \n" +
       "        public void onSuccess() { \n" +
       "          callback.onSuccess(" +
                   nameGenerator.getGetterMethodName(targetKey) + "()); \n" +
       "        }\n" +
...
//     System.out.println(methodCode);
     sourceWriteUtil.writeMethod(writer, creatorMethodSignature, methodCode);
  }
