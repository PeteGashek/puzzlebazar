...
import com.philbeaudoin.gwt.dispatch.client.standard.StandardDispatchAsync;
...
public class StandardDispatchModule extends AbstractDispatchModule {
    ...
    /**
     * Constructs a new GIN configuration module that sets up a {@link com.philbeaudoin.gwt.dispatch.client.DispatchAsync}
