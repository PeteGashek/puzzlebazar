...
public class CachingDispatchAsync implements DispatchAsync {
  ...
  private Map<Action<? extends Result>, Result> cache = new HashMap<Action<? extends Result>, Result>();
  ...
  /*
   * (non-Javadoc)
   * @see com.philbeaudoin.gwt.dispatch.client.DispatchAsync#execute(A, com.google.gwt.user.client.rpc.AsyncCallback)
   */
