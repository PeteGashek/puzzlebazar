 ...
 */
public class PuzzleImpl<T extends Puzzle<?>, D extends PuzzleDetails<?>> implements Puzzle<T> {
   ...
   * meant to be used within {@link com.puzzlebazar.server.puzzle.model.PuzzleDAO PuzzleDAO}.
   *
